...
description: "You can connect your Glean project to any Slack workspace. This lets users in your project
...
1. Go to the [`Settings`](https://glean.io/app/p/settings#integrations) page using the link in the project dropdown
