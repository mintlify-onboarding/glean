...
1. Create a service account in GCP by going to [IAM > service accounts](https://console.cloud.google.com/iam-admin/serviceaccounts)
...
<Info> **"JSON key file"**- BigQuery service accounts use a JSON file as a credential.  You will have to copy and paste the entire contents of this JSON file into the JSON key file field. </Info>
