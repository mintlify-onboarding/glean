...
<Card title="Specifying schemas" icon="pencil">
      For most database types, you can optionally specify a schema.  If you specify a schema in Glean, only tables from that schema will be made available in the [Add Data Model](/data-modeling/add-data-model)  workflow
</Card>
