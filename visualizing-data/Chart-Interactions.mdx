...
description: "Glean charts are designed to be interactive and allow you to dig deeper with simple chart interactions.  Clicking any item in a chart allows you to filter and hovering reveals the underlying chart data."
---
...
<img src="/imgs/Screen_Shot_2020-08-20_at_8.50.52_AM.png" alt="Hover to reveal data" width={200} />
...
![Drag to filter](/imgs/drag_to_filter.png)

<Info> **Dragging to filter will always use the grouping of the x column.**  For example, if the data is grouped by week, then the filter will always be on a week cutoff.  If the data is binned by numeric values, the data filter will be defined on bin boundaries. </Info>
...
<img src="/imgs/Screen_Shot_2020-08-20_at_10.15.21_AM.png" alt="Filter" width="200&quot;" />
