...
<Check> You're ready to begin interacting with your data. Next, [learn how to use the Attributes Tray](/visualizing-data/Attributes-Tray) to filter and breakout your data