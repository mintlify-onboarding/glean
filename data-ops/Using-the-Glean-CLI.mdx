---
title: "Using the Glean CLI"
description: "The Glean CLI allows you to create Preview and Deploy Builds directly from your terminal or continuous integration system."
---
...
4.  Move your Access Key to the default location CLI will look for it
    ...
    <Warning> Once you navigate away from the page, you will not be able to re-download your Access Key. If you lose your Access Key, you will need to delete it and then create a new one. </Warning>
