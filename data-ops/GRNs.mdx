---
title: "Glean Resource Names (GRNs)"
description: "A Glean Resource Name or GRN is a way to reference Glean resources in a stable way. As a resource is changed, renamed, moved between collections, etc. its GRN will always remain the same."
---
