...
description: "Glean can directly create Preview and Deploy Builds using configuration files stored in an external Git repository. This workflow is useful for situations when installing and using the Glean CLI is impractical."
---
...
-  `Type`: The type of build to create. For more details on `Preview` and `Deploy` builds, see [DataOps Overview](/data-ops//index)
