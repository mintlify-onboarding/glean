...
<ParamField path="calculation" type="columnPercentMax| columnPercentTotal| rowPercentTotal">
</ParamField>
<ParamField path="columnId" type="string">
</ParamField>
<ParamField path="type" type="bar">
</ParamField>
<ParamField path="maxWidthPixels" type="number">
</ParamField>
<ParamField path="heightPixels" type="number">
</ParamField>
<ParamField path="labelPlacement" type="floating| non| right">
</ParamField>
<ParamField path="metricFormulaName" type="string">
</ParamField>
...
<ParamField path="color" type="blue| green| none red">
</ParamField>
...
<ParamField path="orderAttributesAccordingToSpec" type="boolean">
    If true, tiles in the attribute tray will be ordered as specified below in `attributeTiles`, with all remaining attributes being placed after. If false (the default), attributes will appear in the default order regardless of their specification in `attributeTiles`.
</ParamField>
<ParamField path="attributeTiles" type="array">
    Per-tile configuration. By default, all non-date attributes in the model will appear as tiles in the attribute tray. Specifying tiles in this array allows for additional tile configuration, including hiding them. Specifying tiles in this array will shift them to the start of the tray.
</ParamField>
